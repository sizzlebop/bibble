...
export class PromptUI {
  ...
  private setupInquirerTheme() {
    ...
    //     Object.assign(inquirer.prompt.prompts.input.prototype, customTheme); // Temporarily disabled due to inquirer version compatibility
    //     Object.assign(inquirer.prompt.prompts.list.prototype, customTheme); // Temporarily disabled due to inquirer version compatibility
    //     Object.assign(inquirer.prompt.prompts.confirm.prototype, customTheme); // Temporarily disabled due to inquirer version compatibility
  }
